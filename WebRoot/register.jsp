...
<!-- 3.网上书城用户注册  start -->
	<div id="divcontent">
		<form action="reg" method="post" onsubmit="return checkForm();">
					...
					<td style="padding: 30px"><h1>新用户注册</h1>
						<table width="70%" border="0" cellspacing="2" class="upline">
							...
							<tr>
								...
								<td><input type="text" class="textinput"  id="username" name="username"  value="${user.username }" onkeyup="checkUsername();"/>
								</td>
							...
							<tr>
								...
								<td colspan="2">
								<input type="text" class="textinput"  value="${user.telephone }"
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width: 50%">
								<input type="text" class="textinput" name="yzm"/>
								</td>
								<td>${yzmmsg }</td>
							</tr>
							<tr>
...
function changeImage(){
	document.getElementById("img").src="checkcode?rand="+Math.random();
}
</script>
</body>
</html>
