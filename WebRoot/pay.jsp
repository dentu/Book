...
<body>
	...
	<form action="confirm?id=${o.id }" method="post" id="divpagecontent">
		订单号：<INPUT TYPE="text" NAME="orderid" value="${o.id }">
		支付金额：<INPUT TYPE="text" NAME="money" value="${o.money }">元
		<div class="divBank">
